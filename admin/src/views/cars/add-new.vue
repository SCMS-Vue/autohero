<template>
  <div class="app-container">
    ...
    <el-form :disabled="submitted" v-bind:model="formData" ref="formData" label-position="left" label-width="320px">
      ...
      <el-form-item label="Bauform / Leistung">
        <el-col :span="11">
          <el-cascader
            :options="body"
            style="width: 100%;"
      ...
      <el-form-item>
        <el-button type="primary" @click.native.prevent="onSubmit">Create</el-button>
...
import { fuletypes, colors, owners, caroptions, features, body } from '@/api/models'
...
export default {
  data() {
    ...
    return {
      ...
      formData: {
        ...
        body: '',
        seats: '',
        registration: '02.2020',
        service: '30.06.2022',
        comfort: features[1].children,
        multimedia: features[2].children,
        visibility: features[3].children,
        security: features[4].children,
        additional: features[5].children,
        options: caroptions,
        enginecmc: '',
  ...
  methods: {
    ...
    formatConsumption(ev) {
      ...
      console.log(this.formData.consumption)
    },
    formatPower(ev) {
        if(ev.target.value) {
    ...
    handleRemove(file, fileList) {
      ...
      let index = this.formData.images.findIndex(ind => ind.id === id);
